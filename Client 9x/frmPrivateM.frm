...
Private Sub rtbR_Change()
  ...
  strVBcrlf1 = Right(rtbR.Text, 1)
                         
  If strVBcrlf1 = Chr(10) Or strVBcrlf1 = " " Then
     Else
      rtbR.SelStart = Len(rtbR.Text)
      rtbR.SelText = rtbR.SelText & vbCrLf
  End If
