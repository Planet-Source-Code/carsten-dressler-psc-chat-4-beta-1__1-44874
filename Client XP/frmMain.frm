...
Begin VB.Form frmMain 
   ...
   Begin VB.Menu mnuOptions 
      ...
      End
      Begin VB.Menu mnuPopupBallon 
         Caption         =   "Show Popup Ballon on Join"
         Checked         =   -1  'True
      End
...
Public Sent As Long
Public size As Long
Dim frmPM(50) As New frmPrivateM
...
Private Sub mnuPopupBallon_Click()
  If mnuPopupBallon.Checked = True Then
     mnuPopupBallon.Checked = False
     Exit Sub
   End If
   
   If mnuPopupBallon.Checked = False Then mnuPopupBallon.Checked = True
End Sub
...
againo:
         ...
         Case "Join"
             ...
             Select Case varsplit(2)
              ...
              If mnuPopupBallon.Checked = True Then
                 Popup " * " & varsplit(1) & " Has Joined...", "User has Joined"
              End If
